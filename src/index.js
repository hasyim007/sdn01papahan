...
export default {
  async fetch(request, env) {
    ...
    if ((url.pathname === '/admin.html' || url.pathname === '/admin') && request.method === 'GET') {
      ...
      // Cloudflare Workers Assets bisa mempersingkat /admin.html jadi /admin di
      // address bar (html_handling auto-trim). Kita tetap ambil file admin.html
      // yang sebenarnya, apa pun bentuk URL yang diminta browser.
